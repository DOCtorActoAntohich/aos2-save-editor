...
impl EncodedU8 {
    ...
    pub const fn decode(self, key: u8) -> u8 {
...
mod tests {
    ...
    fn decodes(#[case] expected_raw: u8, #[case] encoded: EncodedU8, #[case] key: u8) {
    ...
    #[rstest_reuse::apply(mapping)]
    fn encodes(#[case] raw: u8, #[case] expected_encoded: EncodedU8, #[case] key: u8) {
    ...
    fn mapping(#[case] raw: u8, #[case] encoded: EncodedU8, #[case] key: u8) {}
}
