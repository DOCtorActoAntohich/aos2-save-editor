...
fn main() -> anyhow::Result<()> {
    ...
    game_sys._0x10_unlock_alte = EncodedBool::encode_from_raw(true);
    game_sys._0x11_unlock_tsih = EncodedBool::encode_from_raw(true);
    game_sys._0x12_unlock_mira = EncodedBool::encode_from_raw(true);
    game_sys._0x13_unlock_sham = EncodedBool::encode_from_raw(false);
    game_sys._0x14_unlock_nath = EncodedBool::encode_from_raw(true);
    ...
    game_sys._0x17_unlock_saki = EncodedBool::encode_from_raw(true);
    game_sys._0x18_unlock_iru = EncodedBool::encode_from_raw(true);
    game_sys._0x19_unlock_nanako = EncodedBool::encode_from_raw(true);
    game_sys._0x1a_unlock_kae = EncodedBool::encode_from_raw(true);
    game_sys._0x1b_unlock_kyoko = EncodedBool::encode_from_raw(true);
    ...
    game_sys._0x97_is_arcade_hard_1cc_sumika = EncodedBool::encode_from_raw(false);

    game_sys._0x24_unlock_bg_before_the_war = EncodedBool::encode_from_raw(true);
    game_sys._0x25_unlock_bg_war_10k_years_ago = EncodedBool::encode_from_raw(true);
    game_sys._0x26_unlock_bg_canyon_of_wind = EncodedBool::encode_from_raw(true);
    game_sys._0x27_unlock_bg_dust_storm = EncodedBool::encode_from_raw(true);
    game_sys._0x28_unlock_bg_rain_and_sunset = EncodedBool::encode_from_raw(true);
    game_sys._0x29_unlock_bg_equator_doldrums = EncodedBool::encode_from_raw(true);
    game_sys._0x2a_unlock_bg_big_bridge = EncodedBool::encode_from_raw(true);
    ...
    game_sys._0x2e_unlock_bg_nature_10k = EncodedBool::encode_from_raw(true);
    ...
    game_sys._0x3e_unlock_bgm_need_for_speed = EncodedBool::encode_from_raw(true);
    game_sys._0x3f_unlock_bgm_black_hole = EncodedBool::encode_from_raw(true);
    game_sys._0x40_unlock_bgm_distant_thunder = EncodedBool::encode_from_raw(true);
    game_sys._0x41_unlock_bgm_swordfish = EncodedBool::encode_from_raw(true);
    game_sys._0x42_unlock_bgm_shine = EncodedBool::encode_from_raw(true);
    game_sys._0x43_unlock_bgm_expendables = EncodedBool::encode_from_raw(true);
    game_sys._0x44_unlock_bgm_ribbon = EncodedBool::encode_from_raw(true);
    game_sys._0x45_unlock_bgm_moving_out = EncodedBool::encode_from_raw(true);
